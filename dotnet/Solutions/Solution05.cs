...
namespace AdventOfCode2021.Solutions
{
    ...
    {
        protected override long FirstSolution(List<string> lines) => GeneralSolution(lines, false);

        protected override long SecondSolution(List<string> lines) => GeneralSolution(lines, true);
