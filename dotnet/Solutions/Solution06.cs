...
namespace AdventOfCode2021.Solutions
{
    ...
    {
        protected override long FirstSolution(List<string> lines) => GeneralSolution(lines, 80);

        protected override long SecondSolution(List<string> lines) => GeneralSolution(lines, 256);
    ...
    internal class Population
    {
        ...
        public long TotalPopulation() => _populationByAge.Values.Aggregate((a, x) => a + x);
    }
}