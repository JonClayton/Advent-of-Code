...
public partial class Day22 : Solution<long?>
{
    ...
    {
        if (isFirstSolution) Console.WriteLine("First solution");
        ...
        var battle = new Battle(wizard, new Character([], hitPoints, nums[1]));
